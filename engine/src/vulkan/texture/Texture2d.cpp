    ...
    VkAccessFlags2 dstStageMask, VkAccessFlags2 dstAccessMask, bool generateMipMaps)
{
    ...
    auto stagingBuffer = vkCxt.createBuffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VMA_MEMORY_USAGE_CPU_ONLY);
    ...
    vkCxt.recordAndSubmitTransferCmdBuf([&](const CommandBuffer& cmdBuf) {
        ...
        imageBarrierToTransfer.subresourceRange = { VK_IMAGE_ASPECT_COLOR_BIT, 0, VK_REMAINING_MIP_LEVELS, 0, 1 };
